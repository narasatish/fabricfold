...
export const metadata: Metadata = {
  ...
  description: "How FabricFold works for students: book on your phone, drop at the counter, every piece counted, track live, and collect with a one-time code. Pay by UPI, cash or store credit.",
...
const STEPS = [
  ...
  ["Drop at the counter", "Bring your bag to the FabricFold counter on campus. Our staff confirm the item count with you, weigh the load, and log every single garment against your order so nothing gets mixed up in the wash."],
          ...
          <div className="m-split">
            <div>
              ...
              <ul className="m-check">
                ...
                <li>Every payment is recorded, with a GST invoice where GST billing applies</li>
