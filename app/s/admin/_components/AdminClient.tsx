    ...
    <div className="pad">
      ...
      {currentRole >= 4 && (
        ...
        >
          ...
          <div className="grow"><div className="h-sm">{syncingSheet ? "Syncing…" : "Sync to Google Sheet"}</div><div className="muted" style={{ fontSize: 12 }}>Business figures only · also syncs automatically every hour</div></div>
          <Svg name="chevR" size={18} />
        </button>
      )}
